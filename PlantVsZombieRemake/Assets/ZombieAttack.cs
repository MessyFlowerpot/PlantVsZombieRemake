...
public class ZombieAttack : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            // 如果目标或僵尸已死亡，停止攻击
            if (targetPeashooter.IsPeashooterDead() || (zombieHealth != null && zombieHealth.IsZombieDead()))
            {
                isAttacking = false;
                targetPeashooter = null;
                timer = 0f;
